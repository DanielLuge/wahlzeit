...
public class SphericCoordinateTest {
	...
	public void init() {
		...
		sphericCoordinate1 = new SphericCoordinate(new Phi(Math.toRadians(45)), new Theta(Math.toRadians(45)), new Radius(6360));
		sphericCoordinate2 = new SphericCoordinate(new Phi(Math.toRadians(46)), new Theta(Math.toRadians(46)), new Radius(6360));
	}
